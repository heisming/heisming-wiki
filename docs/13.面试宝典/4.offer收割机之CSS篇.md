![img](assets/images/css/CSS面试题.png)
...
![image](assets/images/css/标准盒模型.png)

![img](assets/images/css/IE盒模型.png)
...
![img](assets/images/css/移动端像素尺寸.jpg)
...
![image](assets/images/css/预处理器.png)
...
![img](assets/images/css/PostCss.png)
...
![img](assets/images/css/可视区域.png)
...
![img](assets/images/css/盒模型的层叠规则.png)
...
![img](assets/images/css/relative.png)

**fixed：**元素的定位是相对于 window （或者 iframe）边界的，和其他元素没有关系。但是它具有破坏性，会导致其他元素位置的变化。

![img](assets/images/css/fixed.png)

**absolute：**元素的定位相对于前两者要复杂许多。如果为 absolute 设置了 top、left，浏览器会根据什么去确定它的纵向和横向的偏移量呢？答案是浏览器会递归查找该元素的所有父元素，如果找到一个设置了`position:relative/absolute/fixed`的元素，就以该元素为基准定位，如果没找到，就以浏览器边界定位。如下两个图所示：

![img](assets/images/css/position=relative_absolute_fixed.png)

![img](assets/images/css/absolute.png)
...
![image](assets/images/css/triangle.png)
...
![img](assets/images/css/red_bottom_triangle.png)
...
![img](assets/images/css/red_top_triangle.png)
**（3）三角3**
...
![img](assets/images/css/red_left_triangle.png)
...
![img](assets/images/css/red_right_triangle.png)
...
![img](assets/images/css/red_half_triangle.png)
...
![image](assets/images/css/1px.png)
